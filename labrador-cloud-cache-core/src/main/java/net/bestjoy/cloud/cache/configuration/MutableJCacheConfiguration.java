package net.bestjoy.cloud.cache.configuration;

import net.bestjoy.cloud.cache.codec.DefaultJCacheCodecFactory;
import net.bestjoy.cloud.cache.codec.JCacheCodecFactory;
