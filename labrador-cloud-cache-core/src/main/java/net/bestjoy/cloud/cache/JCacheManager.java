...
import net.bestjoy.cloud.cache.codec.ByteBufferCodec;
import net.bestjoy.cloud.cache.redis.DefaultRedisClientManager;
import net.bestjoy.cloud.cache.spi.JCachingProvider;
