...
import net.bestjoy.cloud.cache.JCache;
import net.bestjoy.cloud.cache.configuration.JCacheRedisProps;
import net.bestjoy.cloud.cache.configuration.MutableJCacheConfiguration;
